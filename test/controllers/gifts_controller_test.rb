...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { comments: @gift.comments, price: @gift.price, title: @gift.title, url: @gift.url, user: @gift.user } }, as: :json
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { comments: @gift.comments, price: @gift.price, title: @gift.title, url: @gift.url, user: @gift.user } }, as: :json
    assert_response 200
  end
